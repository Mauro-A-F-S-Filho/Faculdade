print('Olá seja bem vindo a Sorveteria Mauro Antonio Ferreira Santos Filho')
print('-'*30 +'cardapio' + '-'*30)
print('|' + 'Nº DE BOLAS' + '|' + 'Sabor Tradicional tr'+'|' + 'Sabor Premium pr'+'|' + 'Sabor Especial es'+'|')
print('|' + ' '*5 + '1' + ' '*5 + '|' + ' '*6 + 'R$ 6,00 '+ ' '*6 + '|'+ ' '*4 + 'R$ 7,00' + ' '*5+'|' + ' '*4 + 'R$ 8,00' + ' '*6 +'|')
print('|' + ' '*5 + '2' + ' '*5 + '|' + ' '*5 + 'R$ 10,00 '+ ' '*6 + '|'+ ' '*4 + 'R$ 12,00' + ' '*4+'|' + ' '*3 + 'R$ 14,00' + ' '*6 +'|')
print('|' + ' '*5 + '3' + ' '*5 + '|' + ' '*6 + 'R$ 14,00 '+ ' '*5 + '|'+ ' '*4 + 'R$ 17,00' + ' '*4+'|' + ' '*3 + 'R$ 20,00' + ' '*6 +'|')
print('-'*69)
while True:
